...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Special",
    group: "Bouquets",
    description: "A stunning bouquet made with your favourite photos arranged like flowers. Send us your pictures and we'll create a beautiful memory bouquet wrapped in pink with a ribbon bow. The perfect personalized gift! Upload up to 15 photos you'd like us to use.",
    basePrice: 299,
  ...
  },
  {
    ...
    category: "Gifts",
    group: "Birthday",
    description: "A personalised coffee cup printed with your favourite photos and messages. Upload up to 15 photos and we'll craft a keepsake mug that makes every sip special. Perfect for birthdays, anniversaries, and gifting!",
    basePrice: 399,
  ...
  },
  {
    ...
    category: "Gifts",
    group: "Birthday",
    description: "A magic colour-changing cup that reveals your favourite photos when a hot drink is poured in! Upload up to 15 photos and surprise your loved ones with this magical personalised keepsake.",
    basePrice: 699,
